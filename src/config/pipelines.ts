...
export const PIPELINES: Pipeline[] = [
  ...
  // Russia/Europe
  {
    ...
    capacity: '1.2 million bpd', length: '5,327 km', operator: 'Transneft', countries: ['Russia', 'Belarus', 'Poland', 'Germany', 'Ukraine', 'Czech Republic', 'Hungary'],
  },
  {
  ...
  {
    id: 'trans-israel', name: 'Trans-Israel Pipeline (Eilat-Ashkelon)', type: 'oil', status: 'operating',
    points: [[34.9, 29.6], [35.0, 30.5], [34.8, 31.0], [34.6, 31.6]],
    capacity: '600,000 bpd', length: '254 km', operator: 'EAPC', countries: ['Israel'],
  },
  {
    id: 'ain-dar-abqaiq', name: 'Ain Dar-Abqaiq Pipeline', type: 'oil', status: 'operating',
    points: [[49.2, 25.4], [49.7, 25.9]],
    capacity: '2 million bpd', length: '50 km', operator: 'Saudi Aramco', countries: ['Saudi Arabia'],
  },
  {
  ...
  },
  {
    ...
    capacity: '1.8 million bpd', length: '200 km', operator: 'ADNOC', countries: ['UAE'],
  },
  ...
  },
  {
    ...
    capacity: '900,000 bpd', length: '3,500 km', operator: 'Transneft', countries: ['Russia', 'Belarus'],
  },
  {
    ...
    capacity: '1 million bpd', length: '350 km', operator: 'Transneft', countries: ['Russia'],
  },

  // More Asia Oil
  {
    id: 'west-east-oil', name: 'West-East Oil Pipeline (China)', type: 'oil', status: 'operating',
    points: [[87.6, 43.8], [95.0, 40.0], [105.0, 38.5], [114.0, 36.0], [120.0, 34.0]],
    capacity: '400,000 bpd', length: '4,200 km', operator: 'CNPC', countries: ['China'],
  },
  {
    id: 'shenyang-dalian', name: 'Shenyang-Dalian Pipeline', type: 'oil', status: 'operating',
    points: [[123.4, 41.8], [122.5, 40.5], [121.6, 38.9]],
    capacity: '300,000 bpd', length: '450 km', operator: 'CNPC', countries: ['China'],
  },
  {
    id: 'lanzhou-chengdu', name: 'Lanzhou-Chengdu Pipeline', type: 'oil', status: 'operating',
    points: [[103.8, 36.0], [104.0, 33.0], [104.1, 30.7]],
    capacity: '200,000 bpd', length: '880 km', operator: 'CNPC', countries: ['China'],
  },
  {
  ...
  {
    id: 'mohe-daqing', name: 'Mohe-Daqing Pipeline (ESPO Spur)', type: 'oil', status: 'operating',
  ...
  },
  {
    ...
    capacity: '440,000 bpd', length: '771 km', operator: 'CNPC', countries: ['Myanmar', 'China'],
  },
  ...
  },
  {
    ...
    capacity: '18 bcm/year', length: '620 km', operator: 'Gassco', countries: ['Norway', 'Germany'],
  },
  {
  ...
  },
  {
    ...
    capacity: '20 bcm/year', length: '235 km', operator: 'Interconnector Ltd', countries: ['UK', 'Belgium'],
  },
  {
    id: 'bbl-pipeline', name: 'BBL Pipeline', type: 'gas', status: 'operating',
    points: [[1.7, 52.8], [3.5, 53.0], [5.0, 53.5]],
    capacity: '15 bcm/year', length: '230 km', operator: 'BBL Company', countries: ['UK', 'Netherlands'],
  },
  {
  ...
  },
  {
    ...
    capacity: '36 bcm/year', length: '470 km', operator: 'OPAL Gastransport', countries: ['Germany', 'Czech Republic'],
  },
  {
    id: 'nel', name: 'NEL Pipeline', type: 'gas', status: 'operating',
    points: [[12.1, 54.1], [11.0, 53.8], [9.5, 53.5], [8.0, 53.2]],
    capacity: '20 bcm/year', length: '440 km', operator: 'NEL Gastransport', countries: ['Germany'],
  },
  ...
  {
    id: 'igat-1', name: 'IGAT-1 (Iranian Gas Trunkline)', type: 'gas', status: 'operating',
    points: [[52.5, 27.5], [51.5, 30.5], [50.5, 32.5], [48.5, 35.5], [48.0, 38.0]],
    capacity: '15 bcm/year', length: '1,100 km', operator: 'NIGC', countries: ['Iran'],
  },
  {
  ...
  // India
  {
    id: 'hbj', name: 'HBJ Pipeline (Hazira-Vijaipur-Jagdishpur)', type: 'gas', status: 'operating',
    points: [[72.6, 21.1], [74.5, 22.5], [76.0, 23.5], [79.0, 24.0], [82.0, 26.0], [83.0, 26.8]],
    capacity: '33 mcm/day', length: '2,700 km', operator: 'GAIL', countries: ['India'],
  },
  {
    id: 'dahej-uran', name: 'Dahej-Uran Pipeline', type: 'gas', status: 'operating',
    points: [[72.6, 21.7], [72.8, 20.5], [72.9, 19.0]],
    capacity: '20 mcm/day', length: '500 km', operator: 'GAIL', countries: ['India'],
  },
  {
    ...
    capacity: '16 mcm/day', length: '1,400 km', operator: 'GAIL', countries: ['India'],
  },
  ...
  // Southeast Asia
  {
    ...
    capacity: '15 bcm/year', length: '1,100 km', operator: 'PTT/Petronas', countries: ['Thailand', 'Malaysia', 'Singapore'],
  },
  {
    ...
    capacity: '8 bcm/year', length: '500 km', operator: 'Pertamina', countries: ['Indonesia'],
  },
  ...
  },
  {
    ...
    capacity: '8 bcm/year', length: '210 km', operator: 'Medgaz SA', countries: ['Algeria', 'Spain'],
  },
  {
  ...
  },
  {
    ...
    capacity: '8.7 bcm/year', length: '795 km', operator: 'Jemena', countries: ['Australia'],
  },
  {
    id: 'roma-brisbane', name: 'Roma-Brisbane Pipeline', type: 'gas', status: 'operating',
    points: [[148.8, -26.6], [150.0, -26.5], [152.0, -27.0], [153.0, -27.5]],
    capacity: '6 bcm/year', length: '440 km', operator: 'APA Group', countries: ['Australia'],
  },
  {
    ...
    capacity: '10 bcm/year', length: '937 km', operator: 'APA Group', countries: ['Australia'],
  },

  // ===== AJOUTS STRATÉGIQUES (GÉOPOLITIQUE) =====
  {
    id: 'taps', name: 'Trans-Alaska Pipeline System (TAPS)', type: 'oil', status: 'operating',
    points: [[-148.4, 70.2], [-149.0, 68.0], [-147.7, 64.8], [-146.3, 61.1]],
    capacity: '2.1 million bpd', length: '1,287 km', operator: 'Alyeska Pipeline', countries: ['USA'],
  },
  {
    id: 'baltic-pipe', name: 'Baltic Pipe', type: 'gas', status: 'operating',
    points: [[3.0, 60.0], [6.0, 58.0], [8.0, 56.0], [15.0, 54.0]],
    capacity: '10 bcm/year', length: '900 km', operator: 'Gaz-System / Energinet', countries: ['Norway', 'Denmark', 'Poland'],
  },
  {
    id: 'scp', name: 'South Caucasus Pipeline (SCP)', type: 'gas', status: 'operating',
    points: [[49.9, 40.4], [47.5, 41.3], [44.8, 41.7], [41.6, 41.6]],
    capacity: '24 bcm/year', length: '692 km', operator: 'BP', countries: ['Azerbaijan', 'Georgia', 'Turkey'],
  },
  {
    id: 'nord-stream-1', name: 'Nord Stream 1 (Saboté)', type: 'gas', status: 'sabotaged',
    points: [[28.7, 60.5], [20.0, 56.5], [13.6, 54.1]],
    capacity: '55 bcm/year', length: '1,222 km', operator: 'Nord Stream AG', countries: ['Russia', 'Germany'],
  }
];

// Les couleurs pour DeckGL et l'interface (Version sécurisée sans besoin de src/utils.ts)
...
export const PIPELINE_STATUS_COLORS: Record<string, string> = {
  operating: '#44ff88',
  construction: '#ffaa00',
  sabotaged: '#ff4444', // Ajout de la couleur pour le statut "détruit"
};
